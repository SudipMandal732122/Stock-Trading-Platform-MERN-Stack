        ...
        <div className='container '>
            <div className='row text-center p-5 mt-5 border-top'>
                <div className='col-lg-8'>
                    <a className='text-decoration-none hover-black' href="#">
                        <h3 className='fs-5 '>Brokerage calculator</h3>
                    </a>
                    <ul className='text-muted mt-4' style={{textAlign:"left" ,lineHeight:"2.3", fontSize:"13px"}}>
                        <li>
                        ...
                        <li>
                            For NRI account (PIS), 0.5% or ₹200 executed order for equity (whichever is lower).
                        </li>
                        <li>
